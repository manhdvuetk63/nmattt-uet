...
export function search(aChar) {
  var letter = aChar.toLowerCase();
  var alphabet = "abcdefghijklmnopqrstuvwxyz";
  return alphabet.indexOf(letter);
}

export function reverseSearch(array, dimension) {
  var strArray = [];
  var alphabet = "abcdefghijklmnopqrstuvwxyz";
  var item;
...
export function getColumnVectors(xdimgrams, dimensions) {
  var item;
  var topElement;
  var middleElement;
  var bottomElement;
...
export function getDigrams(aString) {
...
export function getTrigraph(aString) {
  var input = aString.toLowerCase();
  var tempTrigram = "";
  var textLength = input.length;
  var trigramLength;
